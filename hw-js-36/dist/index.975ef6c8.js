...
var _asyncJs = require("./js/async.js");

},{"./js/async.js":"hxLlC"}],"hxLlC":[function(require,module,exports) {
var _apiServiceJs = require("./apiService.js");
var _basiclightbox = require("basiclightbox");
const { alert, notice, info, success, error } = require("6b74581b49f7d5b4");
const _ = require("d867a8546f63c55e");
let page = 1;
let query = "";
let modals = [];
const searchQuery = _.debounce(()=>(0, _apiServiceJs.getImgs)(query, page).then((imgs)=>{
        ...
        `, modals.push(_basiclightbox.create(`
            <img src="${img.largeImageURL}" alt="${img.tags}" />
        `))));
            document.querySelector(".gallery").innerHTML += `<div class="senitel"></div>`;
            setTimeout(()=>new IntersectionObserver((entries)=>entries[0].isIntersecting && (page += 1, searchQuery()), {
                    root: null,
                    rootMargin: "0px",
                    threshold: 0.1
                }).observe(document.querySelector(".senitel")), 500);
        } else error({
...
},{"./apiService.js":"7XMQY","6b74581b49f7d5b4":"9RSjy","d867a8546f63c55e":"3qBDj","basiclightbox":"h9e8q"}],"7XMQY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getImgs", ()=>getImgs);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const getImgs = async (query, page)=>{
    try {
        const response = await (0, _axiosDefault.default).get(`https://pixabay.com/api/?image_type=photo&orientation=horizontal&q=${query}&page=${page}&per_page=12&key=44851747-335961d91f154475be80ef32b`);
        return response;
    } catch (error) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9RSjy":[function(require,module,exports) {
var global = arguments[3];
!function(t, e) {
    e(exports);
}(this, function(t) {
...
},{}]},["farZc","8lqZg"], "8lqZg", "parcelRequiree251")

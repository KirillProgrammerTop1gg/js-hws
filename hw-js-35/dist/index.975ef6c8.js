...
var _movieJs = require("./js/movie.js");

},{"./js/movie.js":"hBFNo"}],"hBFNo":[function(require,module,exports) {
var _moviesAPIJs = require("./moviesAPI.js");
const renderMovie = ()=>(0, _moviesAPIJs.getMovieFetch)().then((movies)=>{
...
document.querySelector(".updateMovies__button").addEventListener("click", (e)=>{
    e.preventDefault();
    if (document.querySelector(".updateMovies__form").checkValidity()) (0, _moviesAPIJs.updateMovieFetch)(document.querySelector(".updateMovies__form").dataset.id, {
...
document.querySelector(".editMovies__button").addEventListener("click", (e)=>{
    ...
    if (document.querySelector(".editMovies__form").checkValidity()) {
        ...
        (0, _moviesAPIJs.editMovieFetch)(document.querySelector(".editMovies__form").dataset.id, editData).then(()=>(renderMovie(), document.querySelector(".editMovies__form").removeAttribute("data-id"), document.querySelector(".backdrop[data-overlay-editMovie]").classList.toggle("is-hidden")));
...
},{"./moviesAPI.js":"11jWb"}],"11jWb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getMovieFetch", ()=>getMovieFetch);
parcelHelpers.export(exports, "delMovieFetch", ()=>delMovieFetch);
parcelHelpers.export(exports, "addMovieFetch", ()=>addMovieFetch);
parcelHelpers.export(exports, "updateMovieFetch", ()=>updateMovieFetch);
parcelHelpers.export(exports, "editMovieFetch", ()=>editMovieFetch);
const getMovieFetch = ()=>fetch("http://localhost:1488/movies").then((response)=>!response.ok ? console.error(`Error get movies, status code ${response.status}`) : response.json());
const delMovieFetch = (id)=>fetch(`http://localhost:1488/movies/${id}`, {
        method: "DELETE"
    }).then((response)=>!response.ok ? console.error(`Error del movie, status code ${response.status}`) : response.json());
const addMovieFetch = (newMovie)=>fetch(`http://localhost:1488/movies/`, {
        method: "POST",
        body: JSON.stringify(newMovie)
    }).then((response)=>!response.ok ? console.error(`Error add movie, status code ${response.status}`) : response.json());
const updateMovieFetch = (id, updateMovie)=>fetch(`http://localhost:1488/movies/${id}`, {
        method: "PUT",
        body: JSON.stringify(updateMovie)
    }).then((response)=>!response.ok ? console.error(`Error update movie, status code ${response.status}`) : response.json());
const editMovieFetch = (id, editMovie)=>fetch(`http://localhost:1488/movies/${id}`, {
        method: "PATCH",
...
},{}]},["farZc","8lqZg"], "8lqZg", "parcelRequire46db")

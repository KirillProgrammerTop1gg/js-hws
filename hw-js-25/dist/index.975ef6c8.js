...
},{"./js/main":"1SICI"}],"1SICI":[function(require,module,exports) {
// task 1
...
document.addEventListener("keydown", (e)=>{
    ...
    if (e.key == keys[currentKeyIndex]) {
        (0, _core.success)({
            text: "You press correct key!!!",
            delay: 500
        });
        currentKeyIndex++;
        if (currentKeyIndex >= 10) (0, _core.success)({
            text: "You win!!!!!!!",
            delay: 1000
        });
        else showKey();
        ...
        (0, _core.error)({
            text: "You press not correct key:(",
            delay: 500
        });
        showKey();
    }
...
},{"@pnotify/core/dist/PNotify.js":"9RSjy","@pnotify/core":"9RSjy","@pnotify/mobile/dist/PNotifyMobile.js":"a8oTw","chart.js/auto":"d8NN9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9RSjy":[function(require,module,exports) {
var global = arguments[3];
!function(t, e) {
    e(exports);
}(this, function(t) {
...
},{}]},["farZc","8lqZg"], "8lqZg", "parcelRequire165b")

...
const toggleUserState = (allUsers, userName)=>new Promise((resolve)=>resolve(updatedUsers = allUsers.map((user)=>user.name === userName ? {
                ...user,
                active: !user.active
            } : user)));
const logger2 = (updatedUsers1)=>console.table(updatedUsers1);
...
},{}]},["farZc","8lqZg"], "8lqZg", "parcelRequire8710")

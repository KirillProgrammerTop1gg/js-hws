...
const showStudents = (obj)=>{
    ...
    document.querySelector(".students").innerHTML = `<tr>
        <td>\u{41D}\u{43E}\u{43C}\u{435}\u{440}</td>
        <td>\u{456}\u{43C}'\u{44F}</td>
        <td>\u{43F}\u{440}\u{456}\u{437}\u{432}\u{438}\u{449}\u{435}</td>
        <td>\u{432}\u{456}\u{43A}</td>
        <td>\u{43A}\u{443}\u{440}\u{441}</td>
        <td>\u{444}\u{430}\u{43A}\u{443}\u{43B}\u{44C}\u{442}\u{435}\u{442}</td>
        <td>\u{441}\u{43F}\u{438}\u{441}\u{43E}\u{43A} \u{43A}\u{443}\u{440}\u{441}\u{456}\u{432}</td>
        <td>\u{432}\u{438}\u{434}\u{430}\u{43B}\u{438}\u{442}\u{438}</td>
        <td>\u{440}\u{435}\u{434}\u{430}\u{433}\u{443}\u{432}\u{430}\u{442}\u{438}</td>
    </tr>`;
...
document.querySelector(".addStudent__submit").addEventListener("click", (e)=>{
    e.preventDefault();
    if (!isValid(document.querySelector(".addStudent__form"))) return;
    students.push({
...
},{}]},["farZc","8lqZg"], "8lqZg", "parcelRequire3663")

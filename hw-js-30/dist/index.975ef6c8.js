...
// task 1
let i = 0;
const timerId = setInterval(()=>(i++, document.querySelector(".msg").innerHTML = `\u{41F}\u{43E}\u{432}\u{456}\u{434}\u{43E}\u{43C}\u{43B}\u{435}\u{43D}\u{43D}\u{44F} ${i}`, i >= 5 ? clearInterval(timerId) : null), 1000);
// task 2
...
document.querySelector(".point").addEventListener("click", (e)=>isGame ? (document.querySelector(".point").getAttribute("isClick") === "1" || result++, e.target.setAttribute("isClick", "1"), document.querySelector(".info").innerHTML = `Result: ${result}`) : null);
// task 4
document.querySelector(".time__but").addEventListener("click", ()=>{
    let time = 0;
    const intervalId = setInterval(()=>(time++, document.querySelector(".alert").innerHTML = `\u{417}\u{430}\u{43B}\u{438}\u{448}\u{438}\u{43B}\u{43E}\u{441}\u{44C} ${(Number(parseFloat(document.querySelector(".time__time").value) * 1000) - time * 100) / 1000} \u{441}\u{435}\u{43A}\u{443}\u{43D}\u{434}`), 100);
...
},{}]},["farZc","8lqZg"], "8lqZg", "parcelRequire932b")
